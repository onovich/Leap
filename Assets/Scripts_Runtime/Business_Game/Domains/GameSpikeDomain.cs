...
namespace Leap {
    ...
    public static class GameSpikeDomain {
        ...
        public static SpikeEntity Spawn(GameBusinessContext ctx, int typeID, Vector2Int pos, Vector2Int size, Vector2 offset, int rotationZ, int index) {
        ...
        public static void SpawnAll(GameBusinessContext ctx, SpikeTM[] blockTMArr, Vector2Int[] posArr, Vector2Int[] sizeArr, Vector2[] offsetArr, int[] rotationZArr, int[] indexArr) {
